...
import ec.gob.educacion.tit.dto.LoginDTO;
import ec.gob.educacion.tit.dto.MenuDTO;
import ec.gob.educacion.tit.dto.ResponseLoginDTO;
...
public class LoginRest {
	...
	private static String usuarioJson(String identificacion, String clave) {
		return "{" + "\"resu\":\"" + identificacion + "\"," + "\"ssap\":\"" + clave + "\", \"prefijoApp\": \"TIT\"}";
