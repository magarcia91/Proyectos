...
public class Constantes {
	...
	public static final String URL_REST_SEGURIDAD = "http://10.200.10.15/serviciosEducacion-web/resources/ValidacionUsuarioLdapSeguridadesJdc/ValidarUsuarioGeneralObtenerRoles";
